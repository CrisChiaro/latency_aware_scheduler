...
func main() {
	...
	customScheduler := NewCustomScheduler(clientset, pauseDescheduler, pastMeasurements)
	latencyMeasurements := NewLatencyMeasurements()
	descheduler := NewDescheduler(clientset, latencyMeasurements, pauseDescheduler, pastMeasurements)
